...
contract PERC20Tnm is PERC20 {
    ...
    function balanceOf(address account) public view override returns (uint256) {
        ...
        require(msg.sender == account, "PERC20Tnm: msg.sender != account");
    ...
    function allowance(
        ...
        // extract original sender of this request. In case of regular (non-signed) `eth_call`
        // msg.sender will be empty address (0x0000000000000000000000000000000000000000)
        require(msg.sender == spender, "PERC20Tnm: msg.sender != account");
    ...
    function transferOne(address receiver) public {
        transfer(receiver, 1);
    }
}
