...
/**
 * @dev Implementation of the {IPERC20} interface.
 *
...
contract PERC20 is Context, IPERC20, IERC20Metadata {
     ...
     * {IPERC20-balanceOf} and {IPERC20-transfer}.
     */
    ...
    function transferFrom(
        ...
        require(
            ...
            "PERC20: transfer amount exceeds allowance"
        );
        unchecked {
     ...
     * problems described in {IPERC20-approve}.
     *
     * Requirements:
     *
     * - `spender` cannot be the zero address.
    ...
    function decreaseAllowance(
        ...
        require(
            ...
            "PERC20: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(
            recipient != address(0),
            "PERC20: transfer to the zero address"
        );
        ...
        require(
            ...
            "PERC20: transfer amount exceeds balance"
        );
        unchecked {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(
            ...
            "PERC20: burn amount exceeds balance"
        );
        unchecked {
